...
class Decision
{
     ...
     * Meeting.
     *
     * @ORM\ManyToOne(targetEntity="Modules\Decision\Entities\Meeting", inversedBy="decisions")
     * @ORM\JoinColumns({
     ...
     * Subdecisions.
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\SubDecision", mappedBy="decision", cascade={"persist", "remove"})
     ...
     * Destroyed by.
     *
     * @ORM\OneToOne(targetEntity="Modules\Decision\Entities\SubDecision\Destroy", mappedBy="target")
     */
