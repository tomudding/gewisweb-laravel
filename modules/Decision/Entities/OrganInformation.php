...
class OrganInformation
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Decision\Entities\Organ", inversedBy="organInformation")
     ...
     *
     * @ORM\ManyToOne(targetEntity="Modules\User\Entities\User")
    ...
    /**
     * @param \User\Entities\User $approver
     */
