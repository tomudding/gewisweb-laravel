...
use Modules\Decision\Entities\SubDecision\Board\Installation;
...
class BoardMember
{
     ...
     * Member lidnr.
     *
     * @ORM\ManyToOne(targetEntity="Modules\Decision\Entities\Member",inversedBy="boardInstallations")
     ...
     * Installation.
     *
     * @ORM\OneToOne(targetEntity="Modules\Decision\Entities\SubDecision\Board\Installation", inversedBy="boardMember")
     * @ORM\JoinColumns({
     ...
     * Set the member.
     *
     * @param \Decision\Entities\Member $member
     */
