...
use Modules\Decision\Entities\SubDecision\Installation;
...
class Member
{
     ...
     * @ORM\OneToOne(targetEntity="Modules\User\Entities\User")
     ...
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\Address", mappedBy="member",cascade={"persist"})
     */
    protected $addresses;
     ...
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\SubDecision\Installation",mappedBy="member")
     */
     ...
     *
     * @ORM\ManyToMany(targetEntity="Modules\Decision\Entities\MailingList", inversedBy="members")
     ...
     * Organ memberships.
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\OrganMember", mappedBy="member")
     */
     ...
     * Board memberships.
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\BoardMember", mappedBy="member")
     */
