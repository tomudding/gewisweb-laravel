...
class Meeting
{
     ...
     * Decisions.
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\Decision", mappedBy="meeting")
     */
    protected $decisions;
     ...
     * Documents.
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\MeetingDocument", mappedBy="meeting")
     ...
     *
     * @ORM\OneToOne(targetEntity="Modules\Decision\Entities\MeetingNotes", mappedBy="meeting")
     */
