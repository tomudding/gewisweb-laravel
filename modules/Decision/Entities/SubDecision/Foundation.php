...
class Foundation extends SubDecision
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\SubDecision\FoundationReference",mappedBy="foundation")
     */
     ...
     *
     * @ORM\OneToOne(targetEntity="Modules\Decision\Entities\Organ",mappedBy="foundation")
     */
    protected $organ;
     ...
     *
     * @return Decision\Entities\Organ
     */
