...
class Organ
{
     ...
     *
     * @ORM\OneToOne(targetEntity="Modules\Decision\Entities\SubDecision\Foundation",inversedBy="organ")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\OrganMember",mappedBy="organ")
     */
    protected $members;
     ...
     *
     * @ORM\ManyToMany(targetEntity="Modules\Decision\Entities\SubDecision")
     ...
     *
     * @ORM\OneToMany(targetEntity="Modules\Decision\Entities\OrganInformation", mappedBy="organ", cascade={"persist", "remove"})
     */
     ...
     * Get the foundation.
     *
     * @return Decision\Entities\SubDecision\Foundation
     */
     ...
     * Set the foundation.
     *
     * @param Decision\Entities\SubDecision\Foundation $foundation
     */
     ...
     *
     * @return \Decision\Entities\OrganInformation
     */
