...
class OrganMember
{
     ...
     * Organ.
     *
     * @ORM\ManyToOne(targetEntity="Modules\Decision\Entities\Organ",inversedBy="members")
     */
    protected $organ;
     ...
     * Member.
     *
     * @ORM\ManyToOne(targetEntity="Modules\Decision\Entities\Member",inversedBy="organInstallations")
     ...
     * Installation.
     *
     * @ORM\OneToOne(targetEntity="Modules\Decision\Entities\SubDecision\Installation",inversedBy="organMember")
     * @ORM\JoinColumns({
